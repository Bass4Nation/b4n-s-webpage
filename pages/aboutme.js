const AboutMe = () => {
  return (
    <>
      <h3>About me page</h3>
      <p>Hi. I&apos;m Kristoffer Snopestad Søderkvist, and are now seeking a job in the IT universe. I Have finished my bachelor assignment, and are currently (17.june) 
        waiting for answere on other exam&apos;s I had. I like to code most
        language I&apos;ve tried yet, but some better than other like JavaScript with
        framework such as Node.js, React.js, NEXT.js. Also like C# and Java. </p>
